...
main(int argc, char *argv[])
{
  ...
  26:	c7 44 24 04 e5 06 00 	movl   $0x6e5,0x4(%esp)
  2d:	00 
  ...
  4c:	e8 af 02 00 00       	call   300 <mkdir>
  ...
  66:	c7 44 24 04 fc 06 00 	movl   $0x6fc,0x4(%esp)
  6d:	00 
  6e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  75:	89 44 24 08          	mov    %eax,0x8(%esp)
  79:	e8 a2 03 00 00       	call   420 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cd:	0f b6 82 1f 07 00 00 	movzbl 0x71f(%edx),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 4fc:	89 55 f0             	mov    %edx,-0x10(%ebp)
        if(s == 0)
 4ff:	ba 18 07 00 00       	mov    $0x718,%edx
...
free(void *ap)
{
 ...
 591:	8b 0d 38 07 00 00    	mov    0x738,%ecx
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5dc:	5d                   	pop    %ebp
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
 5dd:	89 0d 38 07 00 00    	mov    %ecx,0x738
}
 5e3:	c3                   	ret    
  bp = (Header*) ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 ...
 604:	5d                   	pop    %ebp
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
 605:	89 0d 38 07 00 00    	mov    %ecx,0x738
}
 60b:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 15 38 07 00 00    	mov    0x738,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
malloc(uint nbytes)
{
 ...
 63c:	8d 3c dd 00 00 00 00 	lea    0x0(,%ebx,8),%edi
    ...
    if(p == freep)
 643:	3b 0d 38 07 00 00    	cmp    0x738,%ecx
 ...
 662:	89 59 04             	mov    %ebx,0x4(%ecx)
      ...
      freep = prevp;
 665:	89 15 38 07 00 00    	mov    %edx,0x738
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 698:	e8 f3 fe ff ff       	call   590 <free>
  return freep;
 69d:	8b 15 38 07 00 00    	mov    0x738,%edx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
...
morecore(uint nu)
{
 ...
 6bb:	eb a8                	jmp    665 <malloc+0x55>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 6bd:	ba 30 07 00 00       	mov    $0x730,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6c2:	c7 05 38 07 00 00 30 	movl   $0x730,0x738
 6c9:	07 00 00 
 6cc:	c7 05 30 07 00 00 30 	movl   $0x730,0x730
 6d3:	07 00 00 
    base.s.size = 0;
 6d6:	c7 05 34 07 00 00 00 	movl   $0x0,0x734
 6dd:	00 00 00 
