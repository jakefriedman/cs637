...
main(int argc, char *argv[])
{
  ...
  1e:	c7 44 24 04 e5 06 00 	movl   $0x6e5,0x4(%esp)
  25:	00 
  26:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  2d:	e8 ee 03 00 00       	call   420 <printf>
    exit();
  32:	e8 61 02 00 00       	call   298 <exit>
  }
  ...
  44:	e8 af 02 00 00       	call   2f8 <link>
  49:	85 c0                	test   %eax,%eax
  4b:	78 05                	js     52 <main+0x52>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  4d:	e8 46 02 00 00       	call   298 <exit>
  if(argc != 3){
    printf(2, "Usage: ln old new\n");
    exit();
  }
  ...
  5c:	c7 44 24 04 f8 06 00 	movl   $0x6f8,0x4(%esp)
  63:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cd:	0f b6 82 13 07 00 00 	movzbl 0x713(%edx),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 4fc:	89 55 f0             	mov    %edx,-0x10(%ebp)
        if(s == 0)
 4ff:	ba 0c 07 00 00       	mov    $0x70c,%edx
...
free(void *ap)
{
 ...
 591:	8b 0d 2c 07 00 00    	mov    0x72c,%ecx
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5dc:	5d                   	pop    %ebp
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
 5dd:	89 0d 2c 07 00 00    	mov    %ecx,0x72c
}
 5e3:	c3                   	ret    
  bp = (Header*) ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 ...
 604:	5d                   	pop    %ebp
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
 605:	89 0d 2c 07 00 00    	mov    %ecx,0x72c
}
 60b:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 15 2c 07 00 00    	mov    0x72c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
malloc(uint nbytes)
{
 ...
 63c:	8d 3c dd 00 00 00 00 	lea    0x0(,%ebx,8),%edi
    ...
    if(p == freep)
 643:	3b 0d 2c 07 00 00    	cmp    0x72c,%ecx
 ...
 662:	89 59 04             	mov    %ebx,0x4(%ecx)
      ...
      freep = prevp;
 665:	89 15 2c 07 00 00    	mov    %edx,0x72c
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 698:	e8 f3 fe ff ff       	call   590 <free>
  return freep;
 69d:	8b 15 2c 07 00 00    	mov    0x72c,%edx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
...
morecore(uint nu)
{
 ...
 6bb:	eb a8                	jmp    665 <malloc+0x55>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 6bd:	ba 24 07 00 00       	mov    $0x724,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6c2:	c7 05 2c 07 00 00 24 	movl   $0x724,0x72c
 6c9:	07 00 00 
 6cc:	c7 05 24 07 00 00 24 	movl   $0x724,0x724
 6d3:	07 00 00 
    base.s.size = 0;
 6d6:	c7 05 28 07 00 00 00 	movl   $0x0,0x728
 6dd:	00 00 00 
